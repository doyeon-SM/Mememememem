...
namespace MemSystem.Data
{
    ...
    public class MemData : ScriptableObject
    {
        ...
        [Tooltip("이 멤이 기본으로 착용할 악세서리 목록 (머리·몸 부착 3D 모델).\n" +
                 "스폰 시 MemVisual이 슬롯별 뼈에 자동으로 붙입니다.\n" +
                 "같은 슬롯을 여러 개 넣으면 마지막 것만 남습니다.\n" +
                 "모델 프리팹(컬러) × 악세서리 조합으로 외형을 늘릴 수 있습니다.")]
        public MemAccessoryData[] accessories;
