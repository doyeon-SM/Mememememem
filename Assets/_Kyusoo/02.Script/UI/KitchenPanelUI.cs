...
public class KitchenPanelUI : MonoBehaviour
{
    public static KitchenPanelUI Instance { get; private set; }
    ...
    private KitchenRuntime targetFacility;
    public KitchenRuntime TargetFacility => targetFacility;
    ...
    public void OpenPanel(KitchenRuntime facility)
    {
    ...
    private void RefreshCookingModeUI()
    {
        ...
        if (currentUIState == CookingUIState.Cooking && !string.IsNullOrEmpty(targetFacility.currentCookingItem))
        {
            ...
            if (requiredPowerText != null && targetFacility != null)
            {
                requiredPowerText.text = $"{targetFacility.powerConsumeAmount} / {targetFacility.powerConsumeInterval:F0}s";
            }
    ...
    public bool TryDeployMemFromUI(MemData targetMem, CapturedMemEntry targetEntry)
    {
        ...
        {
            targetFacility = FindFirstObjectByType<KitchenRuntime>();
