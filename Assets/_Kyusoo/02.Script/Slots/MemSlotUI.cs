...
public class MemSlotUI : MonoBehaviour, IDropHandler, IPointerClickHandler
{
    ...
    /// <summary>
    /// 해금된 슬롯의 색상 변경 및 배치된 복사 멤의 비주얼 이미지 출력 + 스탯/스탯 텍스트 표시
    /// </summary>
    ...
    /// <summary>
    /// 현재 열려있는 시설이 요구하는 스탯 종류를 찾아 스탯 아이콘과 수치를 계산하여 표시
    /// </summary>
    ...
    /// <summary>
    /// ProductionStatType 종류에 따른 스탯 아이콘 반환
    /// </summary>
    ...
    /// <summary>
    /// stat(Image)과 statText(TextMeshProUGUI)의 활성화 상태 및 Sprite/Text 수정
    /// </summary>
