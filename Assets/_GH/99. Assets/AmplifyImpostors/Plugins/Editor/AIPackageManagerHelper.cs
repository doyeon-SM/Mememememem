...
namespace AmplifyImpostors
{
	...
	public static class AIPackageManagerHelper
	{
		...
		private static readonly string NewVersionDetectedFormat = "A new {0} version {1} was detected and compatible shaders are being imported.\nPlease hit the Update button on your ASE canvas to recompile your shader under the newest version.";
		private static readonly string PackageBaseFormat = "AI_PkgBase_{0}_{1}";
		private static readonly string PackageCRCFormat = "AI_PkgCRC_{0}_{1}";

		private static readonly string URPBakeTemplateGUID = "6ee191abcace33c46a5dd52068b074e0";
		private static readonly string URPOctahedronGUID = "83dd8de9a5c14874884f9012def4fdcc";
		private static readonly string URPSphericalGUID = "da79d698f4bf0164e910ad798d07efdf";

		private static readonly string HDRPBakeTemplateGUID = "5b7fbe5f8e132bd40b11a10c99044f79";
		private static readonly string HDRPOctahedronGUID = "56236dc63ad9b7949b63a27f0ad180b3";
		private static readonly string HDRPSphericalGUID = "175c951fec709c44fa2f26b8ab78b8dd";

		private static readonly string ImpostorsGCincGUID = "806d6cc0f22ee994f8cd901b6718f08d";

		public static readonly Dictionary<int, AISRPPackageDesc> SRPPackageSupport = new Dictionary<int, AISRPPackageDesc>()
		{
			...
			{ ( int )AISRPBaseline.AI_SRP_17_X, new AISRPPackageDesc( AISRPBaseline.AI_SRP_17_X, "d90a25680c82f444b8f94c7566db1e56", "3c7b9024c03153e41988a1e33a5fdedb" ) },
		};

		public static bool Supports( AISRPBaseline baseline ) { return SRPPackageSupport.ContainsKey( ( int )baseline ); }
		...
		{
			if ( !Application.isPlaying && !m_requireUpdateList && m_importingPackage == AIImportFlags.None )
			{
