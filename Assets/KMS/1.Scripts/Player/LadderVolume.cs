...
namespace KMS
{
    ...
    public class LadderVolume : MonoBehaviour
    {
        ...
        [SerializeField]
        private float bottomLocalY = -0.5f;

        [SerializeField]
        private float topLocalY = 0.5f;

        [SerializeField]
        private float climbLocalX;

        [SerializeField]
        private float climbLocalZ = -0.35f;

        [Header("Exit")]

        [SerializeField]
        private Vector3 topExitLocalOffset = new Vector3(0f, 0.25f, -0.8f);

        [SerializeField]
        private Vector3 bottomExitLocalOffset = new Vector3(0f, 0f, -0.8f);
